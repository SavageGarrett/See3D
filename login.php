...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    <a href="test.php?<?php echo $private_id; ?>">Test</a>
    <!-- Navigation -->
    <div id="page-child">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    <form id="" action="." method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="username" class="form-control" placeholder="Username" id="usr" name="usr" maxlength="100">
                        </div>
                        <!-- Order E-Mail Field -->
                        <div class="form-group">
                            <label for="email">
                                <h5 style="margin: 0">Password</h5></label>
                            <input type="password" class="form-control" placeholder="Password" id="email" name="email" maxlength="64">
                        </div>
